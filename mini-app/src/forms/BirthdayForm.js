...
export function renderBirthdayForm(container) {
    container.innerHTML = `
  ...
  `;
    ...
    tg?.MainButton.onClick(async () => {
        ...
        const birthYear = document.getElementById('year').value.trim() || null;
        ...
        try {
            await apiPost('/api/birthdays', { personName, date, birthYear, contact });
            tg?.close();
        }
        catch (err) {
