(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function t(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(e){if(e.ep)return;e.ep=!0;const i=t(e);fetch(e.href,i)}})();const I="https://calendarpi.tail900a1a.ts.net".replace(/\/$/,"");function M(){var a,e;const o=new URLSearchParams(window.location.search).get("token");if(o)return`token ${o}`;const t=((e=(a=window.Telegram)==null?void 0:a.WebApp)==null?void 0:e.initData)??"";return t?`tma ${t}`:null}async function $(n,o){const t=M();if(!t)throw new Error("Открой приложение через кнопку в Telegram");const a=await fetch(`${I}${n}`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:t},body:JSON.stringify(o)});if(!a.ok){const e=await a.text().catch(()=>a.statusText);throw new Error(e||`HTTP ${a.status}`)}}function B(n){if(!n)return"";const[o,t,a]=n.split("-");return`${a}.${t}.${o}`}function k(n,o,t,a,e){if(e){const[,c,s]=n.split("-");return`${s}.${c}`}if(a)return n;const i=o.padStart(2,"0"),r=t.padStart(2,"0");return`${n} ${i}:${r}`}function T(n){return Array.from({length:24},(o,t)=>{const a=String(t).padStart(2,"0");return`<option value="${t}"${t===n?" selected":""}>${a}</option>`}).join("")}function x(n){return Array.from({length:60},(o,t)=>{const a=String(t).padStart(2,"0");return`<option value="${t}"${t===n?" selected":""}>${a}</option>`}).join("")}function L(n){var s;const o=new Date().toISOString().split("T")[0],t=(s=window.Telegram)==null?void 0:s.WebApp;n.innerHTML=`
    ...
    <form id="event-form" novalidate>
      ...
      <div class="field">
        ...
        <div class="date-picker-wrapper">
          <div class="date-display" id="date-display">${B(o)}</div>
  ...
  `;const i=document.getElementById("day"),r=document.getElementById("month");i.value=String(a),r.value=String(t),e==null||e.BackButton.show(),e==null||e.BackButton.onClick(()=>{window.location.href=window.location.pathname});async function c(){const u=document.getElementById("name").value.trim(),p=document.getElementById("day").value,h=document.getElementById("month").value,m=document.getElementById("year").value.trim(),v=document.getElementById("contact").value.trim()||null,l=document.getElementById("error");if(!u){l.textContent="Заполните обязательные поля",l.classList.remove("hidden");return}const f=p.padStart(2,"0"),y=h.padStart(2,"0"),b=m?`${f}.${y}.${m}`:`${f}.${y}`;e==null||e.MainButton.showProgress(),e==null||e.MainButton.disable(),l.classList.add("hidden");try{await $("/api/birthdays",{personName:u,date:b,birthYear:m||null,contact:v}),e==null||e.close()}catch(d){l.textContent=d instanceof Error?d.message:"Ошибка при сохранении",l.classList.remove("hidden"),e==null||e.MainButton.hideProgress(),e==null||e.MainButton.enable()}}e==null||e.MainButton.setText("Добавить день рождения"),e==null||e.MainButton.show(),e==null||e.MainButton.enable(),e==null||e.MainButton.onClick(c)}function O(){return new URLSearchParams(window.location.search).get("form")??""}function C(){var e,i;const n=(e=window.Telegram)==null?void 0:e.WebApp;n==null||n.ready(),n==null||n.expand();const o=document.getElementById("app"),t=new URLSearchParams(window.location.search).has("token");if(!(n!=null&&n.initData)&&!t){o.innerHTML=`
      <div style="padding:16px;font-family:monospace;font-size:13px">
        ...
        WebApp defined: ${((i=window.Telegram)==null?void 0:i.WebApp)!==void 0}<br>
    ...
    `;return}const a=O();a==="event"?L(o):a==="birthday"?A(o):(n==null||n.BackButton.show(),n==null||n.BackButton.onClick(()=>n==null?void 0:n.close()),o.innerHTML=`
      <div class="menu">
